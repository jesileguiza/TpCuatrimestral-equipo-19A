...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="filtro-container">
        ...
        <asp:DropDownList ID="ddlFiltro" runat="server">
            <asp:ListItem Value="ClientesId">ID</asp:ListItem>
    ...
    <asp:GridView ID="dgvClientes" runat="server" AutoGenerateColumns="False" CssClass="tabla-catalogo" DataKeyNames="ClientesId" OnSelectedIndexChanged="dgvClientes_SelectedIndexChanged1">
    ...
    <asp:Button ID="btnAgregar" runat="server" Text="Agregar Cliente" CssClass="btn-accion" OnClick="btnAgregar_Click" />
