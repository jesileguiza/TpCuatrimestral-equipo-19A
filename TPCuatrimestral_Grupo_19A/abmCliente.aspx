<%@ Page Title="" Language="C#" MasterPageFile="~/MasterComercio.Master" AutoEventWireup="true" CodeBehind="abmCliente.aspx.cs" Inherits="TPCuatrimestral_Grupo_19A.abmCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2 id="tituloCliente" runat="server">Agregar Cliente</h2>
    <div class="form-row">
    ...
    <asp:Button ID="btnCancelarCliente" runat="server" Text="Cancelar" OnClick="btnCancelarCliente_Click" />
